const games = [
    ...
    },
    {
        ...
        playerCount: '1–4 (+CPU)',
        duration: '5–12 min',
        description: 'A multiplayer Pac-Man showdown played on the shared screen. Each player drives a Pac-Man from their phone, racing to gobble pellets and cherries for points while dodging four ghosts. Grab a power pellet to turn big and fast — frighten the ghosts and eat smaller players. Die and you\'re out for the round; the highest score among the survivors takes the round. First to the target number of round wins takes the game.',
        rules: [
            'The host opens the game on a shared screen (TV, laptop, etc.)',
            'Players scan the QR code on their phones and enter a name (2–4 players; add CPU Pac-Men to fill in)',
            'The host sets the round length and how many round wins take the game, then hits Start',
            'Your phone is a D-pad — up/down/left/right steer your Pac-Man on the big screen',
            ...
            'Two Pac-Men of equal size just bounce off each other',
