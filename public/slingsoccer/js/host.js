(function () {
  ...
  const WHISTLE_URL = '/slingsoccer/assets/sounds/whistle.mp3';
  ...
  // scripts/test-slingsoccer-ai.js); returns { idx, dx, dy } or null.
  function botPlan(team) {
    if (!world || !window.SlingSoccerAI) return null;
    return window.SlingSoccerAI.plan(world, team);
  }
